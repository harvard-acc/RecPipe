...
import models.data_loader_terabyte
...
class CriteoDataset(Dataset):
    ...
    def __init__(
        ...
        if dataset == "kaggle":
            # Reducing memory requirements for multi-stage ranking data-set storage
            days = 1
        ...
        if memory_map:
            ...
            #TODO: Fix this to be much larger
            max_ids = 1*100*1000
            indices = np.arange(min(len(y), max_ids))
            print("Length of ids is: ", len(indices))
